...
const RecommendationCard = ({ place, index, delay = 0 }) => {
    ...
    // Placeholder image if fetching failed or is slow
    const imageUrl = place.image_url || 'https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?auto=format&fit=crop&q=80&w=1000';
